<template>
  <div class="container">
    <div class="raw d-flex p-2">
      <img :src="book.book.image_url" style="height:150px;" class="rounded float-start shadow" v-if="book.book">
      <div class="d-flex-col">
        <div class="m-2" v-if="book.book">『{{ book.book.title }}』</div>
        <div class="m-2 p-2" v-if="book.book"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-person-circle pt-1" viewBox="0 0 16 16">
