...
class MemosControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create memo' do
    assert_difference('Memo.count') do
      post memos_url, params: { memo: { book_id: @memo.book_id, content: @memo.content, user_id: @memo.user_id } }
    end
  ...
  test 'should update memo' do
    patch memo_url(@memo), params: { memo: { book_id: @memo.book_id, content: @memo.content, user_id: @memo.user_id } }
